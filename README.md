# Stray-Bruce-OS
Название: Stray-Bruce OS v10.7. Железо: ESP32-S3 N16R8, экран ILI9341 (пины 42/40/41/39/38), тач FT6206 (G1/G2). Автор: Stray_2025. Текущий статус: Что работает, а что нет.(Всё сделанно для гугл сёрч чтоб он выстонавливал данные после перехода в новый чат!)
